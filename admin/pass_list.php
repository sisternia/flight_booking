...
<style>
  ...
  */
  ...
  </style><main><?php if (isset($_SESSION['adminId'])) { ?><div class="container-md mt-2"><h1 class="display-4 text-center text-secondary">Passenger List</h1><table class="table table-bordered"><thead class="thead-dark"><tr><th>#</th>< !-- log on to codeastro.com for more projects
  -->
